...
- [2 Runtime Environment Setup](#2-runtime-environment-setup)
  - [2.1 Install MariaDB v10.4.x](#21-install-mariadb-v10-4-x)
  - [2.2 Install Redis v5.x Server](#22-install-redis-v5-x-server)
  ...
  - [2.6 Install Sidekiq](#26-download-project-source-code)
